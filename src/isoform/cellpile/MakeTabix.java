...
public class MakeTabix {
	...
	public static String indexBedFile(String bedFileName) throws Exception {
		...
		final TabixIndex tabixIndex = IndexFactory.createTabixIndex(bedFile, new BEDCodec(), null);
	...
	public static void main(String[] args) throws Exception {
		...
		// Make bgzipped file. Block gzipped files allows indexing and accessing
		// portions of the data
		// Thus, tabix wants this
		// Didnt work when I used file ending .bgzip, but .gz does
		String bedFileName = "C:\\Users\\anton\\java_projects\\isocounter\\data\\UP000005640_9606_lipid.bed";
//		String bedBgzipFileName = "C:\\Users\\anton\\java_projects\\isocounter\\data\\UP000005640_9606_lipid.bed.gz";
		String bedBgzipFileName = MakeTabix.bgzipBedFile(bedFileName);

		// Make tabix index for bed file
		String indexFileName = MakeTabix.indexBedFile(bedFileName);
//		System.out.println(indexFileName);
		String indexBgzipFileName = MakeTabix.indexBedFile(bedBgzipFileName);
...
//		System.out.println(Tribble.tabixIndexFile(bedBgzipFileName));
		...
		final FeatureReader<BEDFeature> reader = AbstractFeatureReader.getFeatureReader(bedBgzipFileName, new BEDCodec());
//		final FeatureReader<BEDFeature> readerUncompressed = AbstractFeatureReader.getFeatureReader(bedFileName, new BEDCodec());
//		final FeatureReader<BEDFeature> reader = AbstractFeatureReader.getFeatureReader(bedFileName, new BEDCodec());
